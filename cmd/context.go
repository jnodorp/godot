...
const headerDateFormat string = "2006-01-02 15:04:05 MST"
...
func (c Context) Header() string {
	return fmt.Sprint(headerPrefix, time.Now().Local().Format(headerDateFormat), headerSuffix)
}
...
// ProfilesContain can be used in templates to determine if profiles are active
