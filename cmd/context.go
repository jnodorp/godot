...
// Decrypt secret
func (c Context) Decrypt(key string) string {
	ciphertext := viper.GetString(fmt.Sprintf("templates.secrets.%s", key))
	log.Println(ciphertext)

	plaintext, err := decrypt([]byte(ciphertext), c.password)
	if err != nil {
